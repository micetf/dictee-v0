    ...
    return (
        <div className="border rounded-lg p-4 bg-white shadow-sm hover:shadow-md transition-shadow flex flex-col h-full">
            ...
            <div className="mt-4 pt-3 border-t flex flex-wrap gap-2">
                ...
                {onDuplicate && (
                    <button
                        onClick={() => onDuplicate(dictation.id)}
                        className="flex-1 md:flex-none px-3 py-2 text-sm border border-purple-600 text-purple-600 hover:bg-purple-50 rounded font-medium transition-colors"
                        title="Dupliquer cette dictée"
                    >
